...
public class CollisionControl : MonoBehaviour {
    ...
    void Start() {
        ...
        for(int i = 0; i < spheres.Length; i++) {
            ...
            spheres[i].GetComponent<Sphere>().setVelocidad(new Vector3(sphereVelocitys[i].x, sphereVelocitys[i].y, 0));
        ...
        for(int i = 0; i < spheres.Length; i++) {
            for(int j = 0; j < spheres.Length; j++) {
                if (j != i) {
                    ...
                    Vector3 vel1 = spheres[i].GetComponent<Sphere>().getVelocidad();
                    Vector3 vel2 = spheres[j].GetComponent<Sphere>().getVelocidad();
                    if (distancia <= 2.0 * radio_s) {
                        ...
                        spheres[i].GetComponent<Sphere>().setVelocidad(new Vector3(sphereVelocitys[i].x, sphereVelocitys[i].y, 0));
                        spheres[j].GetComponent<Sphere>().setVelocidad(new Vector3(sphereVelocitys[j].x, sphereVelocitys[j].y, 0));
                    }
